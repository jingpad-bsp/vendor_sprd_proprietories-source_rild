...
*/
    ...
    {RIL_REQUEST_GET_PREFERRED_NETWORK_TYPE_BITMAP, radio::getPreferredNetworkTypeBitmapResponse},
    {RIL_REQUEST_SET_PREFERRED_NETWORK_TYPE_BITMAP, radio::setPreferredNetworkTypeBitmapResponse},
