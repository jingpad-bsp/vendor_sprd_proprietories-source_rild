...
*/
    ...
    {RIL_UNSOL_LINK_CAPACITY_ESTIMATE, radio::currentLinkCapacityEstimateInd, WAKE_PARTIAL},
    {RIL_UNSOL_PHYSICAL_CHANNEL_CONFIG, radio::currentPhysicalChannelConfigsInd, WAKE_PARTIAL},
    {RIL_UNSOL_EMERGENCY_NUMBER_LIST, radio::currentEmergencyNumberListInd, WAKE_PARTIAL},
